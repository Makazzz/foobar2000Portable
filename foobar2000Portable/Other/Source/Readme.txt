...
user in an INI file next to foobar2000Portable.exe called foobar2000Portable.ini.
...
copy AppNamePortable.ini from this directory to foobar2000Portable.ini next to
foobar2000Portable.exe. The options in the INI file are as follows:
